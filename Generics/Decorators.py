...
def route(pythonclass, path = None):
    """
    Used with Router Class
    :param pythonclass: class name which is a route
    :param path: route path
    :return: n
    """
    if not path:
        raise TypeError("RouteName not specified")
    from Generics import Router
    Router.add_route(path, pythonclass)